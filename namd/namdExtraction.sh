...
#tail -n 2 *atoms*/bench*.out | grep "CPUTime" | awk '{print $4}'

python ../csvGenerator.py namd 20k-atoms*/bench*.out > ../20k_namd_Data.csv

python ../csvGenerator.py namd 3000k-atoms*/bench*.out > ../3M_namd_Data.csv
